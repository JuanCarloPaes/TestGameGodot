...
func _physics_process(delta):
	...
	ataque_anim_soco = "ataqueSoco"+str(anim_numb_soco)
	ataque_anim_chute = "ataqueChute"+str(anim_numb_chute)
	
	ataque_anim_soco2= "ataqueSocoE"+str(anim_numb_soco)
	ataque_anim_chute2 = "ataqueChuteE" +str(anim_numb_chute)
	#===========================================
	...
	#------------------------------------------------
	#COMBO============================================================================
	elif (Input.is_action_just_pressed("seqSoco") or socoDIR) && pode_atacar == true && vivo == true and hitado == false:
		$Timer.start()
		$AreavidaD/CollisionShape2D.set_deferred("disabled",true)
		#$AreavidaE/CollisionShape2D.set_deferred("disabled",true)
	...
	elif (Input.is_action_just_pressed("seqChute")or chuteDIR) && pode_atacar == true && vivo == true and hitado == false:
		$Timer.start()
		$AreavidaD/CollisionShape2D.set_deferred("disabled",true)
		#$AreavidaE/CollisionShape2D.set_deferred("disabled",true)
		#velDesejada = vel #direção que o personagem desliza ao atacar *******************
		...
		if anim_numb_chute == 3:
			anim_numb_chute = 1
	
	
	elif (Input.is_action_just_pressed("seqSocoE") or socoESQ) && pode_atacar == true && vivo == true and hitado == false:
		$Timer.start()
		$AreavidaD/CollisionShape2D.set_deferred("disabled",true)
		#$AreavidaE/CollisionShape2D.set_deferred("disabled",true)
		#velDesejada = -vel #direção que o personagem desliza ao atacar *******************
	...
	elif (Input.is_action_just_pressed("seqChuteE") or chuteESQ) && pode_atacar == true && vivo == true and hitado == false:
		$Timer.start()
		$AreavidaD/CollisionShape2D.set_deferred("disabled",true)
		#$AreavidaE/CollisionShape2D.set_deferred("disabled",true)
		#velDesejada = -vel #direção que o personagem desliza ao atacar *******************
...
func _on_chuteEsquerda_body_entered(body):
	if body.has_method("DESTRUIRchute"):
		body.DESTRUIRchute()
		$socoDireita/socoDireitaShape.set_deferred("disabled",true)
		on_delay_complete()
...
func _on_socoEsquerda_body_entered(body):
	if body.has_method("DESTRUIRsoco"):
		body.DESTRUIRsoco()
		$socoDireita/socoDireitaShape.set_deferred("disabled",true)
		on_delay_complete()
...
func _on_TouchScreenButton2_pressed():
	socoESQ = true
	$CanvasLayer/TouchScreenButton2/botaoDeSocoE.start()
func _on_botaoDeSocoE_timeout():
	socoESQ = false


func _on_TouchScreenButton4_pressed():
	chuteESQ = true
	$CanvasLayer/TouchScreenButton4/botaoDeChuteE.start()
func _on_botaoDeChuteE_timeout():
	chuteESQ = false
#============================================
