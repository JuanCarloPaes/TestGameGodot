...
var faseAtual = "res://Scenes/Personagens/MongeFodao/Fase5(TheyCameFromUnderGround)/Game5Global.tscn"

func _ready():
	$MongeFodao/countdown.hide()
	#$"/root/MenuPrincipal".hide()
	MenuPrincipalMonge.pontosFases = "Musica5/pontosTheyCameFromUnder"
...
func _on_fimDeFase_timeout():
	$TheyCameFromUnderground.queue_free()
